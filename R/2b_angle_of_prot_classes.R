...
p_main <- plot_ridges(class_intervals, names(protein.classes[, -1]),
...
p_supp <- plot_ridges(class_intervals, names(protein.classes[, -1]),
                      c("parkinson disease", "multiple sclerosis",
                        "cystic fibrosis", "graves disease",
                        "autistic disorder", "bipolar disorder",
                        "melanoma", "pancreatic neoplasm",
                        "myocardial ischemia", "hypertrophic cardiomyopathy",
                        "colitis", "periodontitis",
                        "ankylosing spondylitis", "osteoporosis",
                        "asthma", "pulmonary fibrosis",
                        "psoriasis", "lupus erythematosus, systemic",
                        "endometriosis", "iga glomerulonephritis",
                        "retinitis pigmentosa", "cataract",
                        "anemia", "sarcoidosis", "down syndrome"))

save(p_main, p_supp, file = "results/dm_angles.RData")
