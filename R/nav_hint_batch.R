...
# Form groups of 5 disease modules
chunks <- split(1:length(eff), ceiling((1:length(eff))/5))

eff <- eff[chunks[[as.numeric(args[1])]]] %>% 
...
save(ref_eff, ref_hop, eff, imp, file = paste0("results/nav_hint_", args[1],".RData"))
